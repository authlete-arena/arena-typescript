...
```typescript
import { PostSsfTransmitterTransmitterIdEventRegisterSubIdIssSub1 } from "@authlete/arena/models/operations";

let value: PostSsfTransmitterTransmitterIdEventRegisterSubIdIssSub1 = {
  format: "iss_sub",
  iss: "<value>",
  sub: "<value>",
};
