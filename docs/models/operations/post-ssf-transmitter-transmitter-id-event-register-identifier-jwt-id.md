...
```typescript
import { PostSsfTransmitterTransmitterIDEventRegisterIdentifierJwtID } from "@authlete/arena/models/operations";

let value: PostSsfTransmitterTransmitterIDEventRegisterIdentifierJwtID = {
  format: "jwt_id",
  iss: "<value>",
  jti: "<value>",
};
