...
```typescript
import { PostSsfTransmitterTransmitterIdEventRegisterIdentifier8 } from "@authlete/arena/models/operations";

let value: PostSsfTransmitterTransmitterIdEventRegisterIdentifier8 = {
