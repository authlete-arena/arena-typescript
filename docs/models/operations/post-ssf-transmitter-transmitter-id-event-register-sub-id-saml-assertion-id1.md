...
```typescript
import { PostSsfTransmitterTransmitterIDEventRegisterSubIDSamlAssertionId1 } from "@authlete/arena/models/operations";

let value: PostSsfTransmitterTransmitterIDEventRegisterSubIDSamlAssertionId1 = {
