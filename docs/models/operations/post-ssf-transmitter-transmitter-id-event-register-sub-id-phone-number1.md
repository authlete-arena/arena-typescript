...
```typescript
import { PostSsfTransmitterTransmitterIdEventRegisterSubIdPhoneNumber1 } from "@authlete/arena/models/operations";

let value: PostSsfTransmitterTransmitterIdEventRegisterSubIdPhoneNumber1 = {
  format: "phone_number",
