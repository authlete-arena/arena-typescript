# GetSsfTransmitterTransmitterIdDefaultSubjects
...
```typescript
import { GetSsfTransmitterTransmitterIdDefaultSubjects } from "@authlete/arena/models/operations";

let value: GetSsfTransmitterTransmitterIdDefaultSubjects = "NONE";
