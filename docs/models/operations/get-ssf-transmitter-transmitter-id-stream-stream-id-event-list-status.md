...
```typescript
import { GetSsfTransmitterTransmitterIdStreamStreamIdEventListStatus } from "authlete-arena/models/operations";

let value: GetSsfTransmitterTransmitterIdStreamStreamIdEventListStatus =
  "success";
