...
```typescript
import { GetSsfTransmitterTransmitterIdStreamStreamIdEventEventJtiIdentifierPhoneNumber } from "@authlete/arena/models/operations";

let value:
  GetSsfTransmitterTransmitterIdStreamStreamIdEventEventJtiIdentifierPhoneNumber =
    {
      format: "phone_number",
      phoneNumber: "(680) 738-7287 x049",
    };
```
