...
```typescript
import { PostSsfTransmitterTransmitterIdEventRegisterSubId14 } from "@authlete/arena/models/operations";

let value: PostSsfTransmitterTransmitterIdEventRegisterSubId14 = {
  format: "iss_sub",
  iss: "<value>",
  sub: "<value>",
};
