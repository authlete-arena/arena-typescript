...
```typescript
import { GetSsfTransmitterTransmitterIdStreamStreamIdNotFoundStatus } from "authlete-arena/models/operations";

let value: GetSsfTransmitterTransmitterIdStreamStreamIdNotFoundStatus =
  "failure";
