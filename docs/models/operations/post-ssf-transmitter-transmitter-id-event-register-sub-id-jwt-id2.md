...
```typescript
import { PostSsfTransmitterTransmitterIDEventRegisterSubIDJwtId2 } from "@authlete/arena/models/operations";

let value: PostSsfTransmitterTransmitterIDEventRegisterSubIDJwtId2 = {
  format: "jwt_id",
  iss: "<value>",
  jti: "<value>",
};
