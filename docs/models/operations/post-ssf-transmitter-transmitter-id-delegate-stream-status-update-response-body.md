...
| `response`                                                                                                                                                                                                      | [operations.PostSsfTransmitterTransmitterIdDelegateStreamStatusUpdateResponseResponseBody](../../models/operations/post-ssf-transmitter-transmitter-id-delegate-stream-status-update-response-response-body.md) | :heavy_check_mark:                                                                                                                                                                                              | The HTTP response that the internet-facing endpoint should return to the endpoint accessor.<br/>                                                                                                                |