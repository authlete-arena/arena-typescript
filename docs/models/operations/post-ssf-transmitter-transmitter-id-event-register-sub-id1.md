...
```typescript
import { PostSsfTransmitterTransmitterIdEventRegisterSubId1 } from "@authlete/arena/models/operations";

let value: PostSsfTransmitterTransmitterIdEventRegisterSubId1 = {
  format: "account",
