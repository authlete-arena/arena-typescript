...
```typescript
import { PostSsfTransmitterTransmitterIdEventRegisterSubId6 } from "@authlete/arena/models/operations";

let value: PostSsfTransmitterTransmitterIdEventRegisterSubId6 = {
  format: "opaque",
  id: "<id>",
};
```
