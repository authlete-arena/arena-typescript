...
```typescript
import { PostSsfTransmitterTransmitterIdEventRegisterSubIdAccount1 } from "@authlete/arena/models/operations";

let value: PostSsfTransmitterTransmitterIdEventRegisterSubIdAccount1 = {
  format: "account",
