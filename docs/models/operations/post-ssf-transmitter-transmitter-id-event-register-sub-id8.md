...
```typescript
import { PostSsfTransmitterTransmitterIdEventRegisterSubId8 } from "@authlete/arena/models/operations";

let value: PostSsfTransmitterTransmitterIdEventRegisterSubId8 = {
