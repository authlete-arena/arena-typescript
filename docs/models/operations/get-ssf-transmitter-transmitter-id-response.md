# GetSsfTransmitterTransmitterIdResponse

## Example Usage

```typescript
import { GetSsfTransmitterTransmitterIdResponse } from "@authlete/arena/models/operations";

let value: GetSsfTransmitterTransmitterIdResponse = {
  headers: {
    "key": [
      "<value 1>",
      "<value 2>",
...
| `result`                                                                                                                             | [operations.GetSsfTransmitterTransmitterIdResponseBody](../../models/operations/get-ssf-transmitter-transmitter-id-response-body.md) | :heavy_check_mark:                                                                                                                   | N/A                                                                                                                                  |