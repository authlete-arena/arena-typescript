...
```typescript
import { PutSsfTransmitterTransmitterIdDefaultSubjectsRequest } from "@authlete/arena/models/operations";

let value: PutSsfTransmitterTransmitterIdDefaultSubjectsRequest = "NONE";
```
