...
```typescript
import { GetSsfTransmitterTransmitterIdStreamStreamIdEventEventJtiSubId14 } from "authlete-arena/models/operations";

let value: GetSsfTransmitterTransmitterIdStreamStreamIdEventEventJtiSubId14 = {
  format: "jwt_id",
  iss: "<value>",
  jti: "<value>",
};
