...
```typescript
import { PostSsfTransmitterTransmitterIdEventRegisterSubIdOpaque2 } from "@authlete/arena/models/operations";

let value: PostSsfTransmitterTransmitterIdEventRegisterSubIdOpaque2 = {
  format: "opaque",
  id: "<id>",
};
```
