...
```typescript
import { PostSsfTransmitterResponse } from "@authlete/arena/models/operations";

let value: PostSsfTransmitterResponse = {
  headers: {},
  result: {
    transmitter: {
...
| `result`                                                                                                   | [operations.PostSsfTransmitterResponseBody](../../models/operations/post-ssf-transmitter-response-body.md) | :heavy_check_mark:                                                                                         | N/A                                                                                                        |