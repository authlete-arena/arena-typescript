...
```typescript
import { PostSsfTransmitterTransmitterIDEventRegisterSubIDSamlAssertionId2 } from "@authlete/arena/models/operations";

let value: PostSsfTransmitterTransmitterIDEventRegisterSubIDSamlAssertionId2 = {
...
| `assertionId`         | *string*              | :heavy_check_mark:    | N/A                   |