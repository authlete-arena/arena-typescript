...
```typescript
import { PostSsfTransmitterTransmitterIdEventRegisterSubId3 } from "@authlete/arena/models/operations";

let value: PostSsfTransmitterTransmitterIdEventRegisterSubId3 = {
  format: "email",
