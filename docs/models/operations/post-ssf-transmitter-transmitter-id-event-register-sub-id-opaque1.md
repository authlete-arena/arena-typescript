...
```typescript
import { PostSsfTransmitterTransmitterIdEventRegisterSubIdOpaque1 } from "@authlete/arena/models/operations";

let value: PostSsfTransmitterTransmitterIdEventRegisterSubIdOpaque1 = {
  format: "opaque",
  id: "<id>",
};
```
