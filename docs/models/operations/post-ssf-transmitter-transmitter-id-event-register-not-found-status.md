...
```typescript
import { PostSsfTransmitterTransmitterIdEventRegisterNotFoundStatus } from "@authlete/arena/models/operations";

let value: PostSsfTransmitterTransmitterIdEventRegisterNotFoundStatus =
  "success";
