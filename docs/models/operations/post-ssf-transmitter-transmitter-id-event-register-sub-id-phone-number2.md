...
```typescript
import { PostSsfTransmitterTransmitterIdEventRegisterSubIdPhoneNumber2 } from "@authlete/arena/models/operations";

let value: PostSsfTransmitterTransmitterIdEventRegisterSubIdPhoneNumber2 = {
  format: "phone_number",
