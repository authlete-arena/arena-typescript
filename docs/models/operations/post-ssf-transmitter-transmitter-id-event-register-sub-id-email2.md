...
```typescript
import { PostSsfTransmitterTransmitterIdEventRegisterSubIdEmail2 } from "@authlete/arena/models/operations";

let value: PostSsfTransmitterTransmitterIdEventRegisterSubIdEmail2 = {
  format: "email",
