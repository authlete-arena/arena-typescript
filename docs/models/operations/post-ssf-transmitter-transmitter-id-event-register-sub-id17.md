...
```typescript
import { PostSsfTransmitterTransmitterIdEventRegisterSubId17 } from "@authlete/arena/models/operations";

let value: PostSsfTransmitterTransmitterIdEventRegisterSubId17 = {
  format: "phone_number",
