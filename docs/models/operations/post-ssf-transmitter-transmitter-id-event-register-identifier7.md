...
```typescript
import { PostSsfTransmitterTransmitterIdEventRegisterIdentifier7 } from "authlete-arena/models/operations";

let value: PostSsfTransmitterTransmitterIdEventRegisterIdentifier7 = {
  format: "phone_number",
