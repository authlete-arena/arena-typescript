...
| `response`                                                                                                                                                                                               | [operations.DelegateStreamsPostSsfTransmitterTransmitterIdDelegateStreamVerifyResponse](../../models/operations/delegate-streams-post-ssf-transmitter-transmitter-id-delegate-stream-verify-response.md) | :heavy_check_mark:                                                                                                                                                                                       | The HTTP response that the internet-facing endpoint should return to the endpoint accessor.<br/>                                                                                                         |