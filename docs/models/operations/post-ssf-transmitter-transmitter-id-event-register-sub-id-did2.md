...
```typescript
import { PostSsfTransmitterTransmitterIdEventRegisterSubIdDid2 } from "@authlete/arena/models/operations";

let value: PostSsfTransmitterTransmitterIdEventRegisterSubIdDid2 = {
  format: "did",
