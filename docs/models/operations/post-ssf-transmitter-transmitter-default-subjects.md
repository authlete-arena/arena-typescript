# PostSsfTransmitterTransmitterDefaultSubjects
...
```typescript
import { PostSsfTransmitterTransmitterDefaultSubjects } from "authlete-arena/models/operations";

let value: PostSsfTransmitterTransmitterDefaultSubjects = "NONE";
