# PutSsfTransmitterTransmitterIdResponse

## Example Usage

```typescript
import { PutSsfTransmitterTransmitterIdResponse } from "authlete-arena/models/operations";

let value: PutSsfTransmitterTransmitterIdResponse = {
  headers: {
    "key": [],
    "key1": [
      "<value 1>",
...
| `result`                                                                                                                             | [operations.PutSsfTransmitterTransmitterIdResponseBody](../../models/operations/put-ssf-transmitter-transmitter-id-response-body.md) | :heavy_check_mark:                                                                                                                   | N/A                                                                                                                                  |