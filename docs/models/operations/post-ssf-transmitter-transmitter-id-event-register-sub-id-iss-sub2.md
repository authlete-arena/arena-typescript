...
```typescript
import { PostSsfTransmitterTransmitterIdEventRegisterSubIdIssSub2 } from "@authlete/arena/models/operations";

let value: PostSsfTransmitterTransmitterIdEventRegisterSubIdIssSub2 = {
  format: "iss_sub",
  iss: "<value>",
  sub: "<value>",
};
