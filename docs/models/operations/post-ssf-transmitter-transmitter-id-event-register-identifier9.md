...
```typescript
import { PostSsfTransmitterTransmitterIdEventRegisterIdentifier9 } from "@authlete/arena/models/operations";

let value: PostSsfTransmitterTransmitterIdEventRegisterIdentifier9 = {
  format: "uri",
