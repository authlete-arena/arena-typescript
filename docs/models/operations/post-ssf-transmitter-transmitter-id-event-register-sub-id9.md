...
```typescript
import { PostSsfTransmitterTransmitterIdEventRegisterSubId9 } from "@authlete/arena/models/operations";

let value: PostSsfTransmitterTransmitterIdEventRegisterSubId9 = {
  format: "uri",
