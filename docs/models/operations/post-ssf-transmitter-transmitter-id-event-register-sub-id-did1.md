...
```typescript
import { PostSsfTransmitterTransmitterIdEventRegisterSubIdDid1 } from "@authlete/arena/models/operations";

let value: PostSsfTransmitterTransmitterIdEventRegisterSubIdDid1 = {
  format: "did",
