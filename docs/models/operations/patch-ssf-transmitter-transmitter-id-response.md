...
```typescript
import { PatchSsfTransmitterTransmitterIdResponse } from "@authlete/arena/models/operations";

let value: PatchSsfTransmitterTransmitterIdResponse = {
  headers: {},
  result: {
    transmitter: {
      ...
      metadata: {
        ...
        verificationEndpoint:
          "https://transmitter.example.com/ssf/verification",
...
| `result`                                                                                                                                 | [operations.PatchSsfTransmitterTransmitterIdResponseBody](../../models/operations/patch-ssf-transmitter-transmitter-id-response-body.md) | :heavy_check_mark:                                                                                                                       | N/A                                                                                                                                      |