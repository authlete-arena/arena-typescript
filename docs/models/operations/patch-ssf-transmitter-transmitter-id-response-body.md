...
| ------------------------------------------------------------------------------------------------------------------------------------- | ------------------------------------------------------------------------------------------------------------------------------------- | ------------------------------------------------------------------------------------------------------------------------------------- | ------------------------------------------------------------------------------------------------------------------------------------- |
| `result`                                                                                                                              | [operations.PatchSsfTransmitterTransmitterIdResult](../../models/operations/patch-ssf-transmitter-transmitter-id-result.md)           | :heavy_minus_sign:                                                                                                                    | N/A                                                                                                                                   |
| `transmitter`                                                                                                                         | [operations.PatchSsfTransmitterTransmitterIdTransmitter](../../models/operations/patch-ssf-transmitter-transmitter-id-transmitter.md) | :heavy_minus_sign:                                                                                                                    | N/A                                                                                                                                   |