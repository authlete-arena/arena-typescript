...
export interface Env {
  ARENA_BEARER?: string | undefined;
  ARENA_DPOP?: string | undefined;

  ARENA_DEBUG?: boolean | undefined;
}

export const envSchema: z.ZodMiniType<Env, unknown> = z.object({
  ARENA_BEARER: z.optional(z.string()),
  ARENA_DPOP: z.optional(z.string()),

  ARENA_DEBUG: z.optional(z.coerce.boolean()),
});
