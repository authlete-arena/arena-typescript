 ...
 */
export function getSsfTransmitterTransmitterIdStreamStreamIdEventList(
  client: ArenaCore,
  request:
  ...
  Result<
    ...
    | errors.GetSsfTransmitterTransmitterIdStreamStreamIdEventListNotFoundError
    | ArenaError
...
> {
  ...
  const path = pathToFunc(
    "/ssf/transmitter/{transmitter_id}/stream/{stream_id}/event/list",
  )(pathParams);
  ...
  const query = encodeFormQuery({
    ...
    "toe_ge": payload.toe_ge,
    "toe_lt": payload.toe_lt,
  });
  ...
  const context = {
    ...
    operationID:
      "get_/ssf/transmitter/{transmitter_id}/stream/{stream_id}/event/list",
    oAuth2Scopes: null,
  ...
  >(
    ...
    M.jsonErr(
      404,
      errors
        .GetSsfTransmitterTransmitterIdStreamStreamIdEventListNotFoundError$inboundSchema,
      { hdrs: true },
    ),
    M.fail("4XX"),
    M.fail("5XX"),
